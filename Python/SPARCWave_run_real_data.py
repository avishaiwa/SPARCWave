...
from SPACWave_funcs import sparse_kmeans,get_gap_one_s_group
...
if __name__ == '__main__':
    ...
    data_path = "wheat_T32_Q8_new_ord.csv" ### ENTERE THE DATA PATH HERE, E.G. "data_growth_T32_Q2_new_ord.csv"
    label_path = "labels_wheat.csv" ### ENTERE THE LABEL PATH HERE, E.G. "labels_growth.csv"
